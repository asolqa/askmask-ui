...
public class SubscriptionFormComponent {
    ...
    private final SelenideElement subscribeFormTitle = $(".form_head");
    private final SelenideElement emailForSubscriptionField = $("[type=email]");
    private final SelenideElement submitSubscription = $("[name=web_form_submit]");
    private final SelenideElement subscriptionError = $("#POPUP_EMAIL-error");
    private final SelenideElement closeSubscription = $(".close");
