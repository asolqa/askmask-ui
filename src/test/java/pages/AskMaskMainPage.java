...
public class AskMaskMainPage {
    ...
    private final SelenideElement mainMenu = $(".table-menu");
    private final SelenideElement searchBar = $("#title-search_fixed");
    private final SelenideElement categories = $(".items");
    private final SelenideElement newItems = $("[data-class=catalog_tab_drag]");
    private final SelenideElement saleItems = $("[data-class=sale_drag]");
    private final SelenideElement blogArticles = $("[data-class=blog_drag]");
    private final SelenideElement subscribeButton = $(".subscribe_button");
    private final SelenideElement searchField = $("#title-search-input_fixed");
